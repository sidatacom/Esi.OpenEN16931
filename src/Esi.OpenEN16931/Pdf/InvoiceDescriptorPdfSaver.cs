...
namespace Esi.OpenEN16931.PDF
{
    internal class InvoiceDescriptorPdfSaver
    {
        ...
        private static byte[] _CreateFacturXBytes(Stream pdfStream, MemoryStream xmlStream, ZUGFeRDVersion version, Profile profile, string invoiceFilename, string documentTitle = null, string documentDescription = null, string password = null)
        {
            ...
            try
            {
                PropertyInfo manualXmpGenerationProperty = outputDocument.Options.GetType().GetProperty("ManualXmpGeneration");
                if (manualXmpGenerationProperty == null || manualXmpGenerationProperty.PropertyType != typeof(bool))
                {
                    throw new MissingMethodException("Please reference PDFsharp-extended. This fork of PDFsharp is required for PDF/A generation");
                }

                manualXmpGenerationProperty.SetValue(outputDocument.Options, true);
            }
            ...
            switch (version)
            {
                case ZUGFeRDVersion.Version1: metadataResource = "Esi.OpenEN16931.PDF.Resources.PdfMetadataTemplate-1.0.xml"; break;
                case ZUGFeRDVersion.Version20: metadataResource = "Esi.OpenEN16931.PDF.Resources.PdfMetadataTemplate-2.0.xml"; break;
                case ZUGFeRDVersion.Version23: metadataResource = "Esi.OpenEN16931.PDF.Resources.PdfMetadataTemplate-2.3.xml"; break;
            }
        ...
        //    metadataDictionary.Elements.Add("/Filter", new PdfName("/FlateDecode"));
            ...
            rgbProfileDict.CreateStream(_LoadEmbeddedResource("Esi.OpenEN16931.PDF.Resources.sRGB-IEC61966-2.1.icc"));
